...
function AdaptersPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight flex items-center gap-2"><span className="h-6 w-6 flex items-center justify-center rounded-lg bg-amber-500/20 text-amber-400 text-sm">◈</span> Adapters</h1>
