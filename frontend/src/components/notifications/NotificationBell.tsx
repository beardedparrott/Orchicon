  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        className="flex h-11 w-11 min-h-[44px] min-w-[44px] items-center justify-center text-slate-600 dark:text-slate-400 hover:text-white rounded-lg hover:bg-white/5 transition relative focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400/30"
      >
