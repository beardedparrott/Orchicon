...
type WorkerServiceClient interface {
	...
	// UpdateWorker updates a Worker's header fields (name, description,
	// purpose) and/or its RBAC role binding, in one request. Header text is
	// accepted on any worker that is not retired; the role binding is accepted
	// on every status. Neither needs a new version.
...
func NewWorkerServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) WorkerServiceClient {
	...
	return &workerServiceClient{
		...
		deleteWorkerVersion: connect.NewClient[v1.DeleteWorkerVersionRequest, v1.DeleteWorkerVersionResponse](
			httpClient,
			baseURL+WorkerServiceDeleteWorkerVersionProcedure,
...
func NewWorkerServiceHandler(svc WorkerServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	workerServiceDeleteWorkerVersionHandler := connect.NewUnaryHandler(
