...
type WorkItem struct {
	...
	SecretIds     []string `protobuf:"bytes,39,rep,name=secret_ids,json=secretIds,proto3" json:"secret_ids,omitempty"`
...
func (x *WorkItem) GetWorkflowRunId() string {
	if x != nil {
...
func (x *WorkItem) GetWorkflowStepId() string {
	if x != nil {
...
func (x *WorkItem) GetRuntimeImage() string {
	if x != nil {
...
func (x *WorkItem) GetSecretIds() []string {
	if x != nil {
		return x.SecretIds
	}
	return nil
...
const file_orchicon_api_v1_work_item_proto_rawDesc = "" +
	"\n" +
	"\x1forchicon/api/v1/work_item.proto\x12\x0forchicon.api.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\x80\r\n" +
	"\bWorkItem\x12\x0e\n" +
	...
	"workflowId\x12&\n" +
	"\x0fworkflow_run_id\x18\x16 \x01(\tR\rworkflowRunId\x12(\n" +
	"\x10workflow_step_id\x18\x17 \x01(\tR\x0eworkflowStepId\x12H\n" +
	"\x12scheduled_start_at\x18\x14 \x01(\v2\x1a.google.protobuf.TimestampR\x10scheduledStartAt\x123\n" +
	"\x13auto_start_workflow\x18\x15 \x01(\bH\x00R\x11autoStartWorkflow\x88\x01\x01\x12\x1a\n" +
	...
	"\x10spawned_by_title\x18& \x01(\tR\x0espawnedByTitle\x12\x1d\n" +
	"\n" +
	"secret_ids\x18' \x03(\tR\tsecretIdsB\x16\n" +
...
func file_orchicon_api_v1_work_item_proto_init() {
	...
	file_orchicon_api_v1_work_item_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
