...
| `ORCHICON_ASK_TIMEOUT` | `600s` | Ask Orchicon send-accept bound: how long a turn's attempt waits for the serve to accept the sent message once subscribed. A wedged serve fails fast instead of silently queuing |
