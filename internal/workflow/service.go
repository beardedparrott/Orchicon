...
func (s *Service) CreateWorkflowVersion(ctx context.Context, req *connect.Request[apiv1.CreateWorkflowVersionRequest]) (*connect.Response[apiv1.CreateWorkflowVersionResponse], error) {
	...
	if err := recordAudit(ctx, ttx.Tx, tenantID, "workflow.version_created", "workflow", updated.ID,
...
func (s *Service) DeprecateWorkflow(ctx context.Context, req *connect.Request[apiv1.DeprecateWorkflowRequest]) (*connect.Response[apiv1.DeprecateWorkflowResponse], error) {
	...
	if err := recordAudit(ctx, ttx.Tx, tenantID, "workflow.deprecated", "workflow", updated.ID,
...
func (s *Service) DeleteWorkflow(ctx context.Context, req *connect.Request[apiv1.DeleteWorkflowRequest]) (*connect.Response[apiv1.DeleteWorkflowResponse], error) {
	...
	if err := recordAudit(ctx, ttx.Tx, tenantID, "workflow.deleted", "workflow", current.ID,
...
func (s *Service) UpdateWorkflowVersion(ctx context.Context, req *connect.Request[apiv1.UpdateWorkflowVersionRequest]) (*connect.Response[apiv1.UpdateWorkflowVersionResponse], error) {
	...
	if err := recordAudit(ctx, ttx.Tx, tenantID, "workflow.version_updated", "workflow", req.Msg.WorkflowId,
...
func (s *Service) StartWorkflow(ctx context.Context, req *connect.Request[apiv1.StartWorkflowRequest]) (*connect.Response[apiv1.StartWorkflowResponse], error) {
	...
	if err := recordAudit(ctx, ttx.Tx, tenantID, "workflow.run_started", "workflow", createdRun.WorkflowID,
...
func (s *Service) AbortWorkflow(ctx context.Context, req *connect.Request[apiv1.AbortWorkflowRequest]) (*connect.Response[apiv1.AbortWorkflowResponse], error) {
	...
	if err := recordAudit(ctx, ttx.Tx, tenantID, "workflow.run_aborted", "workflow", updated.WorkflowID,
		audit.SnapshotStatus(current.Status), audit.SnapshotStatus(updated.Status)); err != nil {
...
func (s *Service) RetryStepRun(ctx context.Context, req *connect.Request[apiv1.RetryStepRunRequest]) (*connect.Response[apiv1.RetryStepRunResponse], error) {
	...
	if err := recordAudit(ctx, ttx.Tx, tenantID, "workflow.step_retried", "workflow", sr.WorkflowRunID,
...
func (s *Service) ForceProgressWorkflowRun(ctx context.Context, req *connect.Request[apiv1.ForceProgressWorkflowRunRequest]) (*connect.Response[apiv1.ForceProgressWorkflowRunResponse], error) {
	...
	if err := recordAudit(ctx, ttx.Tx, tenantID, "workflow.run_force_progressed", "workflow", run.ID,
...
func (s *Service) RetryFailedWorkflowRun(ctx context.Context, req *connect.Request[apiv1.RetryFailedWorkflowRunRequest]) (*connect.Response[apiv1.RetryFailedWorkflowRunResponse], error) {
	...
	if err := recordAudit(ctx, ttx.Tx, tenantID, "workflow.run_retried", "workflow", updatedRun.ID,
...
func (s *Service) AcquireEditLock(ctx context.Context, req *connect.Request[apiv1.AcquireWorkflowEditLockRequest]) (*connect.Response[apiv1.AcquireWorkflowEditLockResponse], error) {
	...
	if acquired {
		if err := recordAudit(ctx, ttx.Tx, tenantID, "workflow.edit_lock_acquired", "workflow", req.Msg.WorkflowId,
...
func (s *Service) ReleaseEditLock(ctx context.Context, req *connect.Request[apiv1.ReleaseWorkflowEditLockRequest]) (*connect.Response[apiv1.ReleaseWorkflowEditLockResponse], error) {
	...
	if err := recordAudit(ctx, ttx.Tx, tenantID, "workflow.edit_lock_released", "workflow", req.Msg.WorkflowId,
...
func (s *Service) DeleteWorkflowVersion(ctx context.Context, req *connect.Request[apiv1.DeleteWorkflowVersionRequest]) (*connect.Response[apiv1.DeleteWorkflowVersionResponse], error) {
	...
	if err := recordAudit(ctx, ttx.Tx, tenantID, "workflow.version_deleted", "workflow", req.Msg.WorkflowId,
