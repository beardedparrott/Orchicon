...
var cannedWorkflows = []cannedWorkflow{
	{
		...
		Name:        "SDLC (non-human)",
		VersionNote: "Trimmed SDLC: Architect (completeness gate) -> Senior SWE -> PR Reviewer + QA Engineer (parallel, fix-forward contracts) -> Loop Decision -> DevOps (PR/merge) with conflict loop. Design/Code Approver steps removed — quality gates live in QA + PR Review (fix-forward: reviewers fix mechanical findings themselves and report success; only judgment-class blockers loop back to the SSE).",
		StepsJSON: `[
			{"id":"step-sse","name":"Senior Software Engineer","kind":"task","ref":"w_se_senior_software_engineer","worker_version":0,"depends_on":["step-q4xlbg6v"],"gate_policy_ref":"","config":"{\"recovery\":{\"strategy\":\"summarize_restart\",\"max_attempts\":6}}","position_x":-330.0029080215844,"position_y":-58.74360838475371},
			...
			{"id":"step-loop-2","name":"Loop Decision","kind":"loop_decision","ref":"","worker_version":0,"depends_on":["step-pr-reviewer","step-qa"],"gate_policy_ref":"","config":"{\"max_iterations\":6,\"loop_branch\":\"step-sse\",\"success_branch\":\"step-devops-pr\"}","position_x":-265.5238489863543,"position_y":432.1606427012862},
			{"id":"step-devops-pr","name":"DevOps Engineer","kind":"task","ref":"w_se_devops_engineer","worker_version":0,"depends_on":["step-loop-2"],"gate_policy_ref":"","config":"{\"recovery\":{\"strategy\":\"summarize_restart\",\"max_attempts\":6}}","position_x":-274.54837041266813,"position_y":575.0511487425962},
			{"id":"step-q4xlbg6v","name":"Principal Software Architect","kind":"task","ref":"w_se_principal_architect","worker_version":0,"depends_on":[],"gate_policy_ref":"","config":"{\"recovery\":{\"strategy\":\"summarize_restart\",\"max_attempts\":6}}","position_x":-330.3586366719073,"position_y":-215.47301513050206},
			...
			{"id":"step-3rplua0d","name":"Loop Decision","kind":"loop_decision","ref":"","worker_version":0,"depends_on":["step-devops-pr"],"gate_policy_ref":"","config":"{\"max_iterations\":6,\"conflict_value\":\"conflict\",\"exhausted_review\":\"\",\"loop_branch\":\"step-devops-pr\",\"success_branch\":\"step-end\"}","position_x":-56.84691389070679,"position_y":714.4626144687958},
			{"id":"step-end","name":"End","kind":"end","ref":"","worker_version":0,"depends_on":["step-3rplua0d"],"gate_policy_ref":"","config":"{}","position_x":63.82420164593009,"position_y":857.9210020894698}
		]`,
	},
	{
