...
var cannedWorkflows = []cannedWorkflow{
	...
	},
	{
		...
		VersionNote: "Full workflow: Senior SWE → PR Reviewer + QA Engineer (parallel) → Human Approval → DevOps Engineer (PR/merge)",
		StepsJSON: `[
			{"id":"step-sse","name":"Senior Software Engineer","kind":"task","ref":"w_se_senior_software_engineer","worker_version":0,"depends_on":[],"gate_policy_ref":"","config":"{\"recovery\":{\"strategy\":\"summarize_restart\",\"max_attempts\":3}}","position_x":-58,"position_y":-57,"edge_handles":{"e-step-qa-step-loop-2":{"sourceHandle":"source-bottom","targetHandle":"target-top"},"e-step-loop-2-step-sse":{"sourceHandle":"source-loop","targetHandle":"target-top"},"e-step-891p4xm8-step-qa":{"sourceHandle":"source-bottom","targetHandle":"target-top"},"e-step-approval-step-sse":{"sourceHandle":"source-loop","targetHandle":"target-top"},"e-step-sse-step-891p4xm8":{"sourceHandle":"source-bottom","targetHandle":"target-top"},"e-step-loop-2-step-approval":{},"e-step-approval-step-devops-pr":{},"e-step-pr-reviewer-step-loop-2":{"sourceHandle":"source-bottom","targetHandle":"target-top"},"e-step-891p4xm8-step-pr-reviewer":{"sourceHandle":"source-bottom","targetHandle":"target-top"}}},
	...
	},
	{
		...
		VersionNote: "Full workflow with AI-powered approval (Code Approver worker): Senior SWE → PR Reviewer + QA Engineer (parallel) → Code Approver → DevOps Engineer (PR/merge)",
		StepsJSON: `[
			{"id":"step-sse","name":"Senior Software Engineer","kind":"task","ref":"w_se_senior_software_engineer","worker_version":0,"depends_on":[],"gate_policy_ref":"","config":"{\"recovery\":{\"strategy\":\"summarize_restart\",\"max_attempts\":3}}","position_x":-58,"position_y":-57,"edge_handles":{"e-step-qa-step-loop-2":{"sourceHandle":"source-bottom","targetHandle":"target-top"},"e-step-loop-2-step-sse":{"sourceHandle":"source-loop","targetHandle":"target-top"},"e-step-uquk9jv9-step-qa":{"sourceHandle":"source-bottom","targetHandle":"target-top"},"e-step-approval-step-sse":{"sourceHandle":"source-loop","targetHandle":"target-top"},"e-step-sse-step-uquk9jv9":{"sourceHandle":"source-bottom","targetHandle":"target-top"},"e-step-loop-2-step-approval":{},"e-step-approval-step-devops-pr":{},"e-step-pr-reviewer-step-loop-2":{"sourceHandle":"source-bottom","targetHandle":"target-top"},"e-step-uquk9jv9-step-pr-reviewer":{"sourceHandle":"source-bottom","targetHandle":"target-top"}}},
	...
	},
	{
		...
		VersionNote: "Full workflow with AI-powered approval + Principal Architect step: Architect -> Design Approver -> Senior SWE -> PR Reviewer + QA Engineer (parallel) -> Code Approver -> DevOps (PR/merge)",
		StepsJSON: `[
	...
	},
	{
		...
		VersionNote: "Full workflow with human approval + Principal Architect step: Architect -> Approval -> Senior SWE -> PR Reviewer + QA Engineer (parallel) -> Human Approval -> DevOps (PR/merge)",
		StepsJSON: `[
			...
			{"id":"step-m10gxzqj","name":"Principal Software Architect","kind":"task","ref":"w_se_principal_architect","worker_version":0,"depends_on":[],"gate_policy_ref":"","config":"{\"recovery\":{\"strategy\":\"summarize_restart\",\"max_attempts\":3}}","position_x":-74.3622421716779,"position_y":-328.3734649100988,"edge_handles":{"e-step-sse-step-qa":{"sourceHandle":"source-success"},"e-step-qa-step-loop-1":{"sourceHandle":"source-bottom","targetHandle":"target-top"},"e-step-loop-1-step-sse":{"sourceHandle":"source-loop","targetHandle":"target-top"},"e-step-sx85j8pv-step-qa":{"sourceHandle":"source-bottom","targetHandle":"target-top"},"e-step-approval-step-sse":{"sourceHandle":"source-loop","targetHandle":"target-top"},"e-step-ji8iw0jk-step-sse":{"sourceHandle":"source-success","targetHandle":"target-top"},"e-step-sse-step-sx85j8pv":{"sourceHandle":"source-bottom","targetHandle":"target-top"},"e-step-loop-1-step-approval":{"sourceHandle":"source-success"},"e-step-ji8iw0jk-step-m10gxzqj":{"sourceHandle":"source-loop","targetHandle":"target-top"},"e-step-m10gxzqj-step-ji8iw0jk":{"sourceHandle":"source-bottom","targetHandle":"target-top"},"e-step-approval-step-devops-pr":{"sourceHandle":"source-success"},"e-step-pr-reviewer-step-loop-1":{"sourceHandle":"source-bottom","targetHandle":"target-top"},"e-step-sx85j8pv-step-pr-reviewer":{"sourceHandle":"source-bottom","targetHandle":"target-top"}}},
	...
	},
	{
		...
		VersionNote: "UI workflow with AI-powered approval + vision workers: Architect (Vision) -> Design Approver -> Senior SWE (Vision) -> PR Reviewer + QA (Vision, parallel) -> Code Approver -> DevOps (PR/merge)",
		StepsJSON: `[
			...
			{"id":"step-q4xlbg6v","name":"Principal Software Architect - Vision","kind":"task","ref":"w_se_architect_vision","worker_version":0,"depends_on":[],"gate_policy_ref":"","config":"{\"recovery\":{\"strategy\":\"summarize_restart\",\"max_attempts\":6}}","position_x":-370.21653077813266,"position_y":-346.6528223715784,"edge_handles":{"e-step-qa-step-loop-2":{"sourceHandle":"source-bottom","targetHandle":"target-top"},"e-step-loop-2-step-sse":{"sourceHandle":"source-loop","targetHandle":"target-top"},"e-step-mlz9brwx-step-qa":{"sourceHandle":"source-bottom","targetHandle":"target-top"},"e-step-approval-step-sse":{"sourceHandle":"source-loop","targetHandle":"target-top"},"e-step-i64wso0x-step-sse":{"sourceHandle":"source-success","targetHandle":"target-top"},"e-step-sse-step-mlz9brwx":{"sourceHandle":"source-bottom","targetHandle":"target-top"},"e-step-loop-2-step-approval":{"sourceHandle":"source-success"},"e-step-i64wso0x-step-q4xlbg6v":{"sourceHandle":"source-loop","targetHandle":"target-top"},"e-step-q4xlbg6v-step-i64wso0x":{"sourceHandle":"source-bottom","targetHandle":"target-top"},"e-step-approval-step-devops-pr":{"sourceHandle":"source-success"},"e-step-pr-reviewer-step-loop-2":{"sourceHandle":"source-bottom","targetHandle":"target-top"},"e-step-mlz9brwx-step-pr-reviewer":{"sourceHandle":"source-bottom","targetHandle":"target-top"}}},
			{"id":"step-i64wso0x","name":"Design Approver","kind":"approval","ref":"w_se_design_approver","worker_version":0,"depends_on":["step-q4xlbg6v"],"gate_policy_ref":"","config":"{\"reviewer\":\"worker\",\"max_iterations\":6,\"success_branch\":\"step-sse\",\"loop_branch\":\"step-q4xlbg6v\"}","position_x":-333.41658002439067,"position_y":-196.35081675232993},
	...
	},
	{
		...
		VersionNote: "UI workflow with human approval + vision workers: Architect (Vision) -> Approval -> Senior SWE (Vision) -> PR Reviewer + QA (Vision, parallel) -> Human Approval -> DevOps (PR/merge)",
		StepsJSON: `[
			...
			{"id":"step-q4xlbg6v","name":"Principal Software Architect - Vision","kind":"task","ref":"w_se_architect_vision","worker_version":0,"depends_on":[],"gate_policy_ref":"","config":"{\"recovery\":{\"strategy\":\"summarize_restart\",\"max_attempts\":3}}","position_x":-370.21653077813266,"position_y":-346.6528223715784,"edge_handles":{"e-step-qa-step-loop-2":{"sourceHandle":"source-bottom","targetHandle":"target-top"},"e-step-loop-2-step-sse":{"sourceHandle":"source-loop","targetHandle":"target-top"},"e-step-09zk5l01-step-qa":{"sourceHandle":"source-bottom","targetHandle":"target-top"},"e-step-approval-step-sse":{"sourceHandle":"source-loop","targetHandle":"target-top"},"e-step-i64wso0x-step-sse":{"sourceHandle":"source-success","targetHandle":"target-top"},"e-step-sse-step-09zk5l01":{"sourceHandle":"source-bottom","targetHandle":"target-top"},"e-step-loop-2-step-approval":{"sourceHandle":"source-success"},"e-step-i64wso0x-step-q4xlbg6v":{"sourceHandle":"source-loop","targetHandle":"target-top"},"e-step-q4xlbg6v-step-i64wso0x":{"sourceHandle":"source-bottom","targetHandle":"target-top"},"e-step-approval-step-devops-pr":{"sourceHandle":"source-success"},"e-step-pr-reviewer-step-loop-2":{"sourceHandle":"source-bottom","targetHandle":"target-top"},"e-step-09zk5l01-step-pr-reviewer":{"sourceHandle":"source-bottom","targetHandle":"target-top"}}},
