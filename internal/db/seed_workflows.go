...
type cannedWorkflow struct {
	...
	// pins "pr" so the run ends with a PR merged into develop (Quick SWE
	// pushes, DevOps opens + merges).
	GitStrategy string
}
...
var cannedWorkflows = []cannedWorkflow{
	{
		...
		StepsJSON: `[
			...
			{"id":"step-3rplua0d","ref":"","kind":"loop_decision","name":"Loop Decision","config":"{\"max_iterations\":6,\"conflict_value\":\"conflict\",\"exhausted_review\":\"\",\"loop_branch\":\"step-devops-pr\",\"on_missing_decision\":\"success\",\"success_branch\":\"step-l32ezp4b\"}","depends_on":["step-devops-pr"],"position_x":-56.84691389070679,"position_y":714.4626144687958,"worker_version":0,"gate_policy_ref":""},
	...
	},
	{
		...
		StepsJSON: `[
			...
			{"id":"step-e75nato1","ref":"","kind":"loop_decision","name":"Loop Decision","config":"{\"max_iterations\":6,\"conflict_value\":\"conflict\",\"exhausted_review\":\"\",\"loop_branch\":\"step-devops-pr\",\"on_missing_decision\":\"success\",\"success_branch\":\"step-qonmbwyu\"}","depends_on":["step-devops-pr"],"position_x":679.2434240082503,"position_y":817.0275930894546,"worker_version":0,"gate_policy_ref":""},
