...
var cannedWorkflows = []cannedWorkflow{
	...
	},
	{
		...
		VersionNote: "Full workflow with AI-powered approval + Principal Architect step: DevOps (repo) -> Architect -> AI Approver -> Senior SWE -> PR Reviewer -> QA -> AI Approver -> DevOps (PR/merge)",
		StepsJSON: `[
			...
			{"id":"step-i64wso0x","name":"AI Approver","kind":"approval","ref":"w_se_ai_approver","worker_version":0,"depends_on":["step-q4xlbg6v"],"gate_policy_ref":"","config":"{\"reviewer\":\"worker\",\"max_iterations\":3,\"success_branch\":\"step-sse\",\"loop_branch\":\"step-q4xlbg6v\"}","position_x":-333.41658002439067,"position_y":-196.35081675232993}
		]`,
	},
	{
