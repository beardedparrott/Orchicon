...
var cannedWorkflows = []cannedWorkflow{
	...
	},
	{
		...
		VersionNote: "Full workflow with AI-powered approval (Code Approver worker): DevOps Engineer (repo) → Senior SWE → PR Reviewer → QA Engineer → Code Approver → DevOps Engineer (PR/merge)",
		StepsJSON: `[
			{"id":"step-repo","name":"DevOps Engineer","kind":"task","ref":"w_se_devops_engineer","worker_version":0,"depends_on":[],"gate_policy_ref":"","config":"{\"recovery\":{\"strategy\":\"summarize_restart\",\"max_attempts\":3}}","position_x":-344,"position_y":-61,"edge_handles":{"e-step-loop-1-step-qa":{"sourceHandle":"source-success"},"e-step-loop-1-step-sse":{"sourceHandle":"source-loop"},"e-step-loop-2-step-approval":{"sourceHandle":"source-success"},"e-step-loop-2-step-sse":{"sourceHandle":"source-loop"},"e-step-approval-step-devops-pr":{"sourceHandle":"source-success"},"e-step-approval-step-sse":{"sourceHandle":"source-loop"}}},
			{"id":"step-sse","name":"Senior Software Engineer","kind":"task","ref":"w_se_senior_software_engineer","worker_version":0,"depends_on":["step-repo"],"gate_policy_ref":"","config":"{\"recovery\":{\"strategy\":\"summarize_restart\",\"max_attempts\":3}}","position_x":-58,"position_y":-57},
			{"id":"step-pr-reviewer","name":"PR Reviewer","kind":"task","ref":"w_se_pr_reviewer","worker_version":0,"depends_on":["step-sse"],"gate_policy_ref":"","config":"{\"recovery\":{\"strategy\":\"summarize_restart\",\"max_attempts\":3}}","position_x":-55,"position_y":80},
			...
			{"id":"step-approval","name":"Code Approver","kind":"approval","ref":"w_se_code_approver","worker_version":0,"depends_on":["step-loop-2"],"gate_policy_ref":"","config":"{\"reviewer\":\"worker\",\"max_iterations\":4,\"success_branch\":\"step-devops-pr\",\"loop_branch\":\"step-sse\"}","position_x":526,"position_y":442},
			{"id":"step-devops-pr","name":"DevOps Engineer","kind":"task","ref":"w_se_devops_engineer","worker_version":0,"depends_on":["step-approval"],"gate_policy_ref":"","config":"{\"recovery\":{\"strategy\":\"summarize_restart\",\"max_attempts\":3}}","position_x":506,"position_y":564}
		]`,
	},
	{
		...
		VersionNote: "Full workflow with AI-powered approval + Principal Architect step: DevOps (repo) -> Architect -> Design Approver -> Senior SWE -> PR Reviewer -> QA -> Code Approver -> DevOps (PR/merge)",
		StepsJSON: `[
			{"id":"step-repo","name":"DevOps Engineer","kind":"task","ref":"w_se_devops_engineer","worker_version":0,"depends_on":[],"gate_policy_ref":"","config":"{\"recovery\":{\"strategy\":\"summarize_restart\",\"max_attempts\":3}}","position_x":-634.6434161696428,"position_y":-350.29286315717263,"edge_handles":{"e-step-loop-1-step-qa":{"sourceHandle":"source-success"},"e-step-qa-step-loop-2":{},"e-step-loop-1-step-sse":{"sourceHandle":"source-loop"},"e-step-loop-2-step-sse":{"sourceHandle":"source-loop"},"e-step-approval-step-sse":{"sourceHandle":"source-loop"},"e-step-i64wso0x-step-sse":{"sourceHandle":"source-success","targetHandle":"target-top"},"e-step-repo-step-q4xlbg6v":{"sourceHandle":"source-right","targetHandle":"target-left"},"e-step-loop-2-step-approval":{"sourceHandle":"source-success"},"e-step-sse-step-pr-reviewer":{},"e-step-i64wso0x-step-q4xlbg6v":{"sourceHandle":"source-loop","targetHandle":"target-top"},"e-step-q4xlbg6v-step-i64wso0x":{"sourceHandle":"source-bottom","targetHandle":"target-top"},"e-step-approval-step-devops-pr":{"sourceHandle":"source-success"},"e-step-pr-reviewer-step-loop-1":{}}},
	...
	},
	{
		...
		VersionNote: "Full workflow with human approval + Principal Architect step: DevOps (repo) -> Architect -> Approval -> Senior SWE -> PR Reviewer -> QA -> Human Approval -> DevOps (PR/merge)",
		StepsJSON: `[
			{"id":"step-repo","name":"DevOps Engineer","kind":"task","ref":"w_se_devops_engineer","worker_version":0,"depends_on":[],"gate_policy_ref":"","config":"{\"recovery\":{\"strategy\":\"summarize_restart\",\"max_attempts\":3}}","position_x":-372.70086163832957,"position_y":-329.49193145534235,"edge_handles":{"e-step-loop-1-step-qa":{"sourceHandle":"source-success"},"e-step-qa-step-loop-2":{},"e-step-loop-1-step-sse":{"sourceHandle":"source-loop"},"e-step-loop-2-step-sse":{"sourceHandle":"source-loop"},"e-step-approval-step-sse":{"sourceHandle":"source-loop"},"e-step-ji8iw0jk-step-sse":{"sourceHandle":"source-success","targetHandle":"target-top"},"e-step-repo-step-m10gxzqj":{"sourceHandle":"source-right","targetHandle":"target-left"},"e-step-loop-2-step-approval":{"sourceHandle":"source-success"},"e-step-sse-step-pr-reviewer":{},"e-step-ji8iw0jk-step-m10gxzqj":{"sourceHandle":"source-loop","targetHandle":"target-top"},"e-step-m10gxzqj-step-ji8iw0jk":{"sourceHandle":"source-bottom","targetHandle":"target-top"},"e-step-approval-step-devops-pr":{"sourceHandle":"source-success"},"e-step-pr-reviewer-step-loop-1":{}}},
			...
			{"id":"step-pr-reviewer","name":"PR Reviewer","kind":"task","ref":"w_se_pr_reviewer","worker_version":0,"depends_on":["step-sse"],"gate_policy_ref":"","config":"{\"recovery\":{\"strategy\":\"summarize_restart\",\"max_attempts\":3}}","position_x":-55,"position_y":80},
			{"id":"step-loop-1","name":"Loop Decision","kind":"loop_decision","ref":"","worker_version":0,"depends_on":["step-pr-reviewer"],"gate_policy_ref":"","config":"{\"max_iterations\":4,\"loop_branch\":\"step-sse\",\"success_branch\":\"step-qa\"}","position_x":236,"position_y":99},
			{"id":"step-qa","name":"QA Engineer","kind":"task","ref":"w_se_qa_engineer","worker_version":0,"depends_on":["step-loop-1"],"gate_policy_ref":"","config":"{\"recovery\":{\"strategy\":\"summarize_restart\",\"max_attempts\":3}}","position_x":225,"position_y":231},
			{"id":"step-loop-2","name":"Loop Decision","kind":"loop_decision","ref":"","worker_version":0,"depends_on":["step-qa"],"gate_policy_ref":"","config":"{\"max_iterations\":4,\"loop_branch\":\"step-sse\",\"success_branch\":\"step-approval\"}","position_x":502,"position_y":304},
			{"id":"step-approval","name":"Approval","kind":"approval","ref":"","worker_version":0,"depends_on":["step-loop-2"],"gate_policy_ref":"","config":"{\"reviewer\":\"human\",\"max_iterations\":3,\"success_branch\":\"step-devops-pr\",\"loop_branch\":\"step-sse\"}","position_x":526,"position_y":442},
			{"id":"step-devops-pr","name":"DevOps Engineer","kind":"task","ref":"w_se_devops_engineer","worker_version":0,"depends_on":["step-approval"],"gate_policy_ref":"","config":"{\"recovery\":{\"strategy\":\"summarize_restart\",\"max_attempts\":3}}","position_x":506,"position_y":564},
